...
namespace Mumbos_Motors
{
    public class challenge : ModdingTab
    {
        ...
        0x70 ??? (??? Int32)
        0x78 Vehicle File UUID (4 Bytes)

        0xA4 Challenge SFX File UUID (4 Bytes)
        0xBC Intro Dialogue File UUID (4 Bytes)
        0xC0 Intro After Jiggy Dialogue File UUID (4 Bytes)
        0xC4 Objective Dialogue File UUID (4 Bytes)
        0xC8 Success Dialogue File UUID (4 Bytes)
        0xCC Failure Dialogue File UUID (4 Bytes)
        0xD0 Game Style Dialogue File UUID (4 Bytes)
        0xD4 Wimp Out Dialogue File UUID (4 Bytes)
